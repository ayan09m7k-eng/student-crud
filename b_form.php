                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <?php 
                                                // Mapped to photo1 column in MySQL
                                                $ownImg = $row["photo1"] ?? '';
                                    ...
                                    <!-- 10th Marksheet (photo2) -->
                                    <td class="text-center">
                                        <?php if (!empty($row["photo2"]) && file_exists("uploads/" . $row["photo2"])): ?>
                                            <?php $file10 = "uploads/" . htmlspecialchars($row["photo2"]); ?>
                                    ...
                                    <!-- 12th Marksheet (photo3) -->
                                    <td class="text-center">
                                        <?php if (!empty($row["photo3"]) && file_exists("uploads/" . $row["photo3"])): ?>
                                            <?php $file12 = "uploads/" . htmlspecialchars($row["photo3"]); ?>
                                    ...
                                    <!-- Signature (photo4) -->
                                    <td class="text-center">
                                        <?php if (!empty($row["photo4"]) && file_exists("uploads/" . $row["photo4"])): ?>
                                            <?php $fileSign = "uploads/" . htmlspecialchars($row["photo4"]); ?>
